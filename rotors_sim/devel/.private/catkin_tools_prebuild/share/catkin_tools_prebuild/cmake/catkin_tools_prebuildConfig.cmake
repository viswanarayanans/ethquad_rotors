...
if("TRUE" STREQUAL "TRUE")
  set(catkin_tools_prebuild_SOURCE_PREFIX /home/viswa/rotors_quad/ethquad_rotors/rotors_sim/build/catkin_tools_prebuild)
  set(catkin_tools_prebuild_DEVEL_PREFIX /home/viswa/rotors_quad/ethquad_rotors/rotors_sim/devel/.private/catkin_tools_prebuild)
  ...
  set(catkin_tools_prebuild_INSTALL_PREFIX /home/viswa/rotors_quad/ethquad_rotors/rotors_sim/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/viswa/rotors_quad/ethquad_rotors/rotors_sim/build/catkin_tools_prebuild/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/viswa/rotors_quad/ethquad_rotors/rotors_sim/devel/.private/catkin_tools_prebuild/lib;/home/viswa/rotors_quad/Trial_Repo/gazebo_link_attacher_ws/devel/lib;/home/viswa/.local/share/Trash/files/link_attach/gazebo_link_attacher_ws/devel/lib;/home/viswa/rotors_quad/ethquad_rotors/rotors_sim/devel/lib;/opt/ros/kinetic/lib)
