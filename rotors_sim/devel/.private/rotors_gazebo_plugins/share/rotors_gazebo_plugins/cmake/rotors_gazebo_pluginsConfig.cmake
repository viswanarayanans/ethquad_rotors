...
if("TRUE" STREQUAL "TRUE")
  set(rotors_gazebo_plugins_SOURCE_PREFIX /home/viswa/rotors_quad/ethquad_rotors/rotors_sim/src/rotors_gazebo_plugins)
  set(rotors_gazebo_plugins_DEVEL_PREFIX /home/viswa/rotors_quad/ethquad_rotors/rotors_sim/devel/.private/rotors_gazebo_plugins)
  ...
  set(rotors_gazebo_plugins_INSTALL_PREFIX /home/viswa/rotors_quad/ethquad_rotors/rotors_sim/install)
...
if(NOT "/home/viswa/rotors_quad/ethquad_rotors/rotors_sim/src/rotors_gazebo_plugins/include;/usr/include/eigen3 " STREQUAL " ")
  set(rotors_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/viswa/rotors_quad/ethquad_rotors/rotors_sim/src/rotors_gazebo_plugins/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/viswa/rotors_quad/ethquad_rotors/rotors_sim/src/rotors_gazebo_plugins/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/viswa/rotors_quad/ethquad_rotors/rotors_sim/devel/.private/rotors_gazebo_plugins/lib;/home/viswa/rotors_quad/Trial_Repo/gazebo_link_attacher_ws/devel/lib;/home/viswa/.local/share/Trash/files/link_attach/gazebo_link_attacher_ws/devel/lib;/home/viswa/rotors_quad/ethquad_rotors/rotors_sim/devel/lib;/opt/ros/kinetic/lib)
