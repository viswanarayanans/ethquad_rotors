...
if("TRUE" STREQUAL "TRUE")
  set(rotors_evaluation_SOURCE_PREFIX /home/viswa/rotors_quad/ethquad_rotors/rotors_sim/src/rotors_evaluation)
  set(rotors_evaluation_DEVEL_PREFIX /home/viswa/rotors_quad/ethquad_rotors/rotors_sim/devel/.private/rotors_evaluation)
  ...
  set(rotors_evaluation_INSTALL_PREFIX /home/viswa/rotors_quad/ethquad_rotors/rotors_sim/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotors_evaluation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/viswa/rotors_quad/ethquad_rotors/rotors_sim/src/rotors_evaluation/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/viswa/rotors_quad/ethquad_rotors/rotors_sim/devel/.private/rotors_evaluation/lib;/home/viswa/rotors_quad/Trial_Repo/gazebo_link_attacher_ws/devel/lib;/home/viswa/.local/share/Trash/files/link_attach/gazebo_link_attacher_ws/devel/lib;/home/viswa/rotors_quad/ethquad_rotors/rotors_sim/devel/lib;/opt/ros/kinetic/lib)
